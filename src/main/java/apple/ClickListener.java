...
public class ClickListener implements Listener {
    ...
    private final static String IMPROPER_FORMAT_MESSAGE = "I can't read the language on this scroll..";
    ...
    public void rightClickListener(PlayerInteractEvent event) {
        ...
        if (action == Action.RIGHT_CLICK_AIR || action == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (Objects.requireNonNull(event.getItem()).getType() == Material.PAPER) {
                ...
                List<String> lore = Objects.requireNonNull(event.getItem().getItemMeta()).getLore();
